...
<template>
    ...
    <div class="register-wrapper">
        ...
        <div class="form-wrapper">
            <h2 class="title mb-4">Logowanie</h2>
            <Form :validation-schema="schema"  :initial-values="formValues">                
                ...
                <span class="form-info mb-3">Nie masz jeszcze konta? <router-link to="/rejestracja" class="yg-main text-decoration-none">Zarejestruj się</router-link></span>
                <button class="yg-btn btn" type="submit">Zaloguj się</button>
            </Form>
        </div>
    </div>
    <Footer class="pt-0"/>
